...
LOG_DIR = ROOT_DIR / "logs" / "directml"
...
RESUME_CHECKPOINT = CHECKPOINT_DIR / "pretrain_768_resume.pth"
MODEL_CHECKPOINT = CHECKPOINT_DIR / "pretrain_768.pth"
OUTPUT_MODEL = OUT_DIR / "pretrain_768.pth"
...
parser = argparse.ArgumentParser(
    description="Run MiniMind DirectML pretraining with automatic resume and logs."
)

parser.add_argument(
    "--fresh",
    action="store_true",
    help="Delete previous pretrain checkpoint/logs and restart from scratch.",
)
