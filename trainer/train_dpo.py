...
def train_epoch(epoch, loader, iters, start_step=0, wandb=None):
    ...
    for step, (input_ids, labels) in enumerate(loader, start=start_step + 1):
        ...
        if directml_fp16:
            scaled_loss = loss * args.directml_loss_scale
            ...
            if directml_fp16:
                for parameter in model.parameters():
                    if parameter.grad is not None:
                        parameter.grad.div_(args.directml_loss_scale)
...
if __name__ == "__main__":
    ...
    directml_fp16 = is_directml_device(args.device) and args.dtype == "float16"
    ...
    optimizer = optim.AdamW(
        ...
        eps=args.directml_adam_eps if directml_fp16 else 1e-8,
    )
